...
public class ProjectController {
    ...
    @PostMapping("/exist")
    public Mono<ResponseEntity<String>> existProject(@RequestBody ProjectDTO projectDTO, @RequestHeader("Authorization") String token) {
        return projectService.existsByNameAndContract(projectDTO, token);
    }
